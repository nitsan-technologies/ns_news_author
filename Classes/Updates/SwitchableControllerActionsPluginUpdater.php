...
namespace NITSAN\NsNewsAuthor\Updates;
...
class SwitchableControllerActionsPluginUpdater implements UpgradeWizardInterface
{
    ...
    {
        return 'Migrates plugin and settings of existing EXT:ns_news_author plugins using switchableControllerActions';
    }
    ...
    public function getDescription(): string
    {
        ...
        $description .= 'to use the new plugins available. This upgrade wizard is needed, if you upgrade ext:ns_news_author ';
